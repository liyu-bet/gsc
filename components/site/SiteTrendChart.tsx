  ...
  return (
    <div className="site-chart-wrap">
      ...
      <div className="site-chart-shell">
        {tooltip ? (
          <div className="site-tooltip" style={{ left: `min(${Math.max((hoverX ?? 60) / width * 100, 10)}%, calc(100% - 250px))` }}>
        ...
        >
          ...
          {hoverX !== null ? <line x1={hoverX} x2={hoverX} y1={padding} y2={height - padding} stroke="#9aa7ba" strokeWidth="1" /> : null}
          {hoverIndex !== null
            ? seriesMeta.map((metric) => {
